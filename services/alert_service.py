...
def _compute_alerts_cached(csv_path: str, settings: dict) -> List[Dict[str, Any]]:
    """Cached alert generation to prevent looping dataset on every rerun."""
...
class AlertService:
    ...
    def scan_for_alerts(self) -> List[Dict[str, Any]]:
        ...
        # Call the cached module-level function to avoid iterating the whole dataset on every UI rerun
        return _compute_alerts_cached(self.data_service.csv_path, settings)
